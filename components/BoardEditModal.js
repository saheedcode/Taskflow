...
export default function BoardEditModal({ board, onClose, onSave }) {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      setSubmitting(false);
      setError(err.message || "Couldn't save board settings.");
    }
  }
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-ink-900/50 p-4">
      ...
      >
        <h2 id="edit-board-title" className="font-display text-[18px] font-bold text-ink">
          Board settings
        </h2>
        ...
        <div className="mt-4">
          <label className="mb-1.5 block text-[14.5px] font-medium text-ink-faint">Name</label>
          <input
            ref={nameInputRef}
            value={name}
        ...
        <div className="mt-3">
          <label className="mb-1.5 block text-[14.5px] font-medium text-ink-faint">Description</label>
          <textarea
            value={description}
        ...
        <div className="mt-3">
          <label className="mb-1.5 block text-[14.5px] font-medium text-ink-faint">Color</label>
